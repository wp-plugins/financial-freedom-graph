...
Contributors: srconnell, dancameron, sproutventure
...
4. Go to Appearance > Widgets to add and configure your financial graphs.
	...
	* The Goal => What is the goal? Example, $1,000,000 (number values only-$ and commas are acceptable)
	* Currently => Used to state where you are towards your goal. Example, $23,234 (number values only-$ and commas are acceptable)
	* Text Color => Text color for current state. Example, white or #ffffff (Use HEX colors or CSS color names only - http://www.w3schools.com/CSS/css_colornames.asp)
	* Background Color => background color for graph. Example, black or #000000 (Use HEX colors or CSS color names only - http://www.w3schools.com/CSS/css_colornames.asp)
